...
int bosluk1(char *board,char targetCol,int targetRow);/*Bu fonksiyonlar filin */
int bosluk2(char *board,char targetCol,int targetRow);/*durumuna göre bosluk */
int bosluk3(char *board,char targetCol,int targetRow);/* konrol eder */ 
int bosluk4(char *board,char targetCol,int targetRow);
...
[find_stone(targetCol,targetRow)]<=122 ))
			return bosluk1(board,targetCol,targetRow);

		else if(targetRow-sourceRow<0 && (int)targetCol-(int)sourceCol<0 && 
!((int)board[find_stone(targetCol,targetRow)]>=97 && (int)board
[find_stone(targetCol,targetRow)]<=122 ))
			return bosluk2(board,targetCol,targetRow);

		else if(targetRow-sourceRow>0 && (int)targetCol-(int)sourceCol<0 && 
!((int)board[find_stone(targetCol,targetRow)]>=97 && (int)board
[find_stone(targetCol,targetRow)]<=122 ))
			return bosluk3(board,targetCol,targetRow);

		else if(targetRow-sourceRow<0 && (int)targetCol-(int)sourceCol>0 && 
!((int)board[find_stone(targetCol,targetRow)]>=97 && (int)board
[find_stone(targetCol,targetRow)]<=122 ))
			return bosluk4(board,targetCol,targetRow);
		else return 0;
	}
	else{
...
int bosluk1(char *board,char targetCol,int targetRow)
{
	int i;
...
int bosluk2(char *board,char targetCol,int targetRow)
{
	int i;
	for(i=1; i<targetRow; i++)
	{
...
int bosluk3(char *board,char targetCol,int targetRow)
{
	int i;
	for(i=1; i<targetRow; i++)
	{
